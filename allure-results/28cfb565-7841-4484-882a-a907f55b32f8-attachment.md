...
> 19 |     expect(response.status()).toBe(201)
  ...
  23 |     const userid = await userdata.id
  24 |     const username = await userdata.name
  25 |     const useremail = await userdata.email
  26 |     console.log(`new user created ${username}`)
  27 |     console.log(`new email created ${useremail}`)
  28 |     console.log(`new UserID created ${userid}`)
  29 |     console.log('-------------------------------------')
